...
export interface NexusGenObjects {
  ...
  Transaction: { // root type
    blocknumber?: string | null; // String
    createdat: string; // String!
    fromaddress?: string | null; // String
    gaslimit?: string | null; // String
    gasprice?: string | null; // String
    gasused?: string | null; // String
    hash?: string | null; // String
    id: number; // Int!
    input?: string | null; // String
    status?: number | null; // Int
    timestamp?: string | null; // String
    toaddress?: string | null; // String
